(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_app_preferences_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! @ionic-native/app-preferences/ngx */
      "./node_modules/@ionic-native/app-preferences/__ivy_ngcc__/ngx/index.js");

      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(appPreferences) {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function ngOnInit() {
            ...
            var suitsPref = this.appPreferences.suite('group.ch.netty.app');
            suitsPref.fetch('imageData').then(function (res) {
              console.log(res);
              alert('group.ch.netty.app');
              alert(res);
            });
          }
        }]);
